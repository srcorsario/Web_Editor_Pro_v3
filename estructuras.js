...
// Método de trabajo: Edita este archivo directamente para añadir/eliminar categorías o cambiar rangos.
// Los cambios surten efecto inmediatamente al guardar y recargar la página.

window.APP_VERSIONS = window.APP_VERSIONS || {};
window.APP_VERSIONS.estructuras = '2.0.0'; // Actualizado: Modo estrictamente manual (Sin localStorage)
...
// =================================================================================
// ASIGNACIÓN GLOBAL DIRECTA
// =================================================================================
window.ESTRUCTURA_RG = ESTRUCTURA_RG;
window.ESTRUCTURA_USOPEN = ESTRUCTURA_USOPEN;
