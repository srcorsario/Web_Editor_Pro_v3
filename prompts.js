...
REGLA DE FIDELIDAD TERMINOLÓGICA (obligatoria): si el nombre en español usa un término específico de especie, corte o variedad (ej. "atún rojo" frente a atún blanco/bonito, "ternera" frente a buey/vacuno adulto, "gamba" frente a langostino), tradúcelo SIEMPRE por el término equivalente exacto en cada idioma de destino — nunca lo sustituyas por una especie, corte o variedad distinta aunque sea similar o más común en ese idioma.

REGLA DE CONSISTENCIA CON EL INGLÉS DE REFERENCIA: si el texto en inglés ya ha optado por un término distinto de la traducción literal del español (por ejemplo, "beef" en vez de "veal" para "ternera"), sigue ese MISMO criterio en todos los idiomas de destino en vez de traducir literalmente desde el español. El objetivo es que el nombre describa el mismo plato de forma consistente en todos los idiomas, con el inglés como término de referencia cuando haya divergencia.
...
REGLA DE FIDELIDAD TERMINOLÓGICA (obligatoria, la más importante): si el nombre en español usa un término específico de especie, corte o variedad (ej. "atún rojo" frente a atún blanco/bonito, "ternera" frente a buey/vacuno adulto, "gamba" frente a langostino), tradúcelo SIEMPRE por el término equivalente exacto en cada idioma de destino — nunca lo sustituyas por una especie, corte o variedad distinta aunque sea similar o más habitual en ese idioma. Esto es especialmente crítico en pescados/mariscos y tipos de carne, donde confundir la especie es un error grave de carta.

REGLA DE CONSISTENCIA CON EL INGLÉS DE REFERENCIA: cuando el texto en inglés de un elemento ya haya optado por un término distinto de la traducción literal del español (por ejemplo, "beef" en vez de "veal" para "ternera"), sigue ese MISMO criterio en todos los idiomas de destino para ese elemento, en vez de traducir literalmente desde el español. El objetivo es que el nombre describa el mismo plato de forma consistente en todos los idiomas, usando el inglés como criterio de desempate cuando diverge del literal español.
