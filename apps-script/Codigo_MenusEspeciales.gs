...
function doGet(e) {
  ...
  // Sin parámetro "accion" reconocido, se hace lo mismo por defecto (es la única función real
...
function doPost(e) {
  if (e && e.parameter && e.parameter.accion === 'eliminarMenu') {
    return eliminarMenu(e);
  }
